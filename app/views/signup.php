<?php
// require 'helpers.php';
include dirname(__DIR__) . './controllers/signup-con.php';
// loadView("header"); 
...
<html lang="en">
  ...
  >
      ...
      <!-- ===== Content Area Start ===== -->
      <div
        class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden mt-8.5 mr-24.5 ml-24.5 mb-24.5 "
      >
              ...
              <div class="flex flex-wrap items-center">
                ...
                >
                  <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                    <span class="mb-1.5 block font-medium">A new software to Manage Your Vehicle</span>
                    <h2
