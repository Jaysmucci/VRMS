<?php
session_start();
include_once '../controllers/pub-user-con.php';
...
<div class="container ml-4 px-4 py-8">
  ...
  <table style="width: 76rem;" class="table-fixed divide-x divide-y divide-gray-200 dark:divide-gray-700">
    <thead>
      <tr class="bg-gray-200 text-left dark:bg-gray-800">
        ...
        <th class="text-sm px-2 py-2 font-medium text-black dark:text-white">Email</th>
        <th class="text-sm px-2 py-2 font-medium text-black dark:text-white">Role</th>
        <th class="text-sm px-2 py-2 font-medium text-black dark:text-white">createdAt</th>
    ...
    <tbody id="tableBody" class="text-center text-sm bg-white divide-x divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
      ...
      <tr>
        ...
        <td class="border-r px-2 py-2 whitespace-nowrap"><?php echo htmlspecialchars($vehicle['email']) ?></td>
        <td class="border-r px-2 py-2 whitespace-nowrap"><?php echo htmlspecialchars($vehicle['role']) ?></td>
        <td class="border-r px-2 py-2 whitespace-nowrap"><?php echo htmlspecialchars($vehicle['createdAt']) ?></td>
