              ...
              >
                ...
                <nav>
                  <ol class="flex items-center gap-2">
                    ...
                    <li class="text-primary">pub-users</li>
                  </ol>
                </nav>
              </div>
  ...
  <div class="max-w-full overflow-x-auto">
    <table class="w-full table-auto">
      ...
      <tbody>
        ...
        >
          <h5 class="font-medium text-black dark:text-white"><?php echo htmlspecialchars($user['id']) ?></h5>
          <!-- <p class="text-sm"></p> -->
        </td>
          <td
            class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11"
          >
            <h5 class="font-medium text-black dark:text-white"><?php echo htmlspecialchars($user['name']) ?></h5>
            <!-- <p class="text-sm"></p> -->
          </td>
          <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
            <p class="text-black dark:text-white"><?php echo htmlspecialchars($user['email']) ?></p>
          </td>
          <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
            <p class="text-black dark:text-white"><?php echo htmlspecialchars($user['password']) ?></p>
          </td>
          <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
            <p class="text-black dark:text-white"><?php echo htmlspecialchars($user['image']) ?></p>
          </td>
          <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
            <p
