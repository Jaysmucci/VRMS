...
>
  ...
  >
    ...
    <div @click.away="open = false" class="mt-19.6 ml-60 bg-white rounded-lg shadow dark:bg-black w-full max-w-md p-4 md:p-5 relative overflow-y-auto" style="max-height:86%;">
        ...
        <!-- Modal body -->
        <form class="pt-4 md:pt-5" method="post" action="../controllers/drivers-con.php" enctype="multipart/form-data">
            <div class="grid gap-2 mb-4 grid-cols-2" style="margin-top: -0.7rem;">
                <div class="col-span-2 md:col-span-1">
                    <label for="name" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                    <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" placeholder="Input Driver's Name" required>
                </div>
                <div class="col-span-2 md:col-span-1">
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="identity_card_no" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">Identity Card No</label>
                    <input type="text" name="identity_card_no" id="identity_card_no" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" placeholder="ID Card No" required>
                </div>
                <div class="col-span-2 md:col-span-1">
                    <label for="unit_no" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit No</label>
                    <input type="text" name="unit_no" id="unit_no" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" placeholder="Unit No" required>
                </div>
                <div class="col-span-2 md:col-span-1">
                    <label for="lga" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">LGA</label>
                    <select id="lga" name="lga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark">
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="phone_number" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number</label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="owner_id" class="block uppercase mb-2 text-sm font-medium text-gray-900 dark:text-white">Owner ID</label>
                    <input type="text" name="owner_id" id="owner_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" placeholder="Input LGA Code" required>
                </div>
                <div class="col-span-2 md:col-span-1">
