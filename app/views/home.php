...
session_start();
  ...
  include_once '../controllers/count-con.php';
  loadView("sidebar");
          ...
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    <h4
                      class="text-title-md font-bold text-black dark:text-white"
                    >
                      <?php 
                      $u = countNum($data['users']);
                      if ($u) {
                        echo formatNum($u);
                    ...
                    <span class="text-sm font-medium">TOTAL PUB USERS</span>
                  </div>
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">TOTAL DRIVERS</span>
                  </div>
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">TOTAL OWNERS</span>
                  </div>
...
>
  ...
  <div>
    ...
    <div id="chartContainer" class="mx-auto flex justify-center">
    <canvas id="myChart" style="height: 263px;"></canvas>
  </div>
  </div>
</div>
          ...
          <!-- ====== Chart Two Start -->
  <div style="height:22rem;" class="col-span-12 rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
    <div class="mb-4 justify-between gap-4 sm:flex">
        <div>
          <h4 class="text-xl font-bold text-black dark:text-white">
            Highest Registered LGA
          </h4>
        </div>
        <div>
      ...
      <div>
        ...
        <canvas id="myPieChart" width="400" height="260"></canvas>
      </div>
  </div>
  <!-- ====== Chart Two End -->
