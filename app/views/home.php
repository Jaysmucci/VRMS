              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">Total KEKE Owners</span>
                  </div>
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">Total BIKE Owners</span>
                  </div>
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">Total KEKE Drivers</span>
                  </div>
              ...
              >
                ...
                <div class="mt-4 flex items-end justify-between grid grid-cols-2">
                  <div class="grid grid-rows-2">
                    ...
                    <span class="text-sm font-medium">Total BIKE Drivers</span>
                  </div>
    ...
    <div class="w-full px-8 sm:w-1/2">
      <div class="flex w-full items-center">
        ...
        <p
          class="flex w-full justify-between text-sm font-medium text-black dark:text-white"
        >
          <span> Total number of owners</span>
          <span> 34% </span>
        </p>
      </div>
    </div>
    <div class="w-full px-8 sm:w-1/2">
      <div class="flex w-full items-center">
        ...
        <p
          class="flex w-full justify-between text-sm font-medium text-black dark:text-white"
        >
          <span> Total number of pubUsers </span>
          <span> 45% </span>
        </p>
      </div>
    </div>
    <div class="w-full px-8 sm:w-1/2">
      <div class="flex w-full items-center">
        ...
        <p
          class="flex w-full justify-between text-sm font-medium text-black dark:text-white"
        >
          <span> Total number of Registered Vehicle </span>
          <span> 12% </span>
        </p>
      </div>
    </div>
